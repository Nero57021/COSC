...
int main()
{
	...
	CalculatorView form;
	form.Text = "C++ Calculator - Test sample [Jeremy Bayangos]";
...
String ^ CPPCalculator::CalculatorView::InstantOperators(String^ enteredStr)
{
	...
	{
		result = maths.NaturalLog(inputNumber); // log e
	}
...
void CPPCalculator::CalculatorView::TextUpdate(String^ inputText)
{
